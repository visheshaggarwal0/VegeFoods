...
(function ($) {
	...
	function makeTimer() {
		...
		var endTime = new Date("10 January 2025 10:00:00 GMT+05:30");
...
document.addEventListener('DOMContentLoaded', function () {
	const addToCartButtons = document.querySelectorAll('.add-to-my-cart')
...
document.addEventListener('DOMContentLoaded', function () {
	const removeFromCart = document.querySelectorAll('.remove-from-my-cart')
...
document.addEventListener('DOMContentLoaded', function () {
	const subtFromCart = document.querySelectorAll('.subt-from-cart')

	subtFromCart.forEach((button) => {
		button.addEventListener('click', function (event) {
			event.preventDefault()

			const pdtId = this.getAttribute('data-item-id')

			fetch(`/subt_from_cart/${pdtId}`, {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json'
				}
...
document.addEventListener('DOMContentLoaded', function () {
	const removeFromWishlist = document.querySelectorAll('.remove-from-my-wishlist')
...
document.querySelectorAll('.pagination-button').forEach((button) => {
	button.addEventListener('click', function () {
		console.log('Pagination button clicked:', this.dataset.page)
	})
})
